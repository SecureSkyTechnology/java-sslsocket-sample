...
for bitlen in 512 768 1023 1024 1025 2047 2048 2049 4096; do
  ...
  openssl req -new -sha256 -days 365 -key rsa${bitlen}.pem -subj "/C=JP/ST=Tokyo/L=Chiyoda/O=SST/OU=test/CN=sha2.rsa${bitlen}.localdomain/emailAddress=sha2.rsa${bitlen}@localhost.localdomain" -out rsa${bitlen}.csr
